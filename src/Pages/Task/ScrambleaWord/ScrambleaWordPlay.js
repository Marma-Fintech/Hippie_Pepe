  ...
  return (
    <div className="quiz-play-task">
      ...
      <div className="scramble-wordbox-container">
        <div className="scramble-wordbox">
          <p className="word-s">I</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">T</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">B</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">C</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">I</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">N</p>
        </div>
        <div className="scramble-wordbox">
          <p className="word-s">O</p>
        </div>
      </div>
      ...
      <button className="quitz-btn">Next</button>
    </div>
  );
};
