       ...
       <div className="market-place">
        ...
        <div className="row">
          ...
          <div className="col-5 text-right market-color">
            <p className="mb0"><img src={memetv} /> 258K</p>
          </div>
          </div>
        ...
        <div className="row">
          <div className="col-6">
            <div className="market-card p5">
              ...
              <h4 className="mb0 market-color flex"><img className="mr5" src={memetv} /> 200</h4>
              </div>
              <div className="p10">
                <button type="button" className="btn-card">BUY</button>
              </div>
