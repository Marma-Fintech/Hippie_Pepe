              ...
              >
                ...
                {showWelcomeMessage && (
                  <div className="row img-res">
                    <div className="col-md-12 ">
                      <div>
                        <img draggable="false" className="animation-logo" src={welcome} />{" "}
                      </div>
                    </div>
                  ...
                  <div id="glitch-background" className=" center-content">
                    <div className="about-trasition-1">
                      ...
                      <div className="pt-3 pb-5 about-pad">
                        ...
                        We were all born to meme.The world seems to have forgotten this and taken itself too seriously.
                        TheMemeTV is here to spread joy and to spread other things also, I think but mostimportantly to
                       
                        </p>
                        <p className="pb-0 f18">
                          {" "}
                          #doNothing
                        </p>
                        ...
                        <p className="text-1">
                          So, you also watch <span className="bg-span">TheMemeTv</span> and #doNothing. Okay??
                        </p>
                  ...
                  <div id="glitch-background" className=" center-content">
                    <div className="about-trasition-1">
                      ...
                      <div className="pt-2 pb-1 about-pad">
                        ...
                        Get ready to watch hilarious stuff, play some silly games and earn tokens while you #doNothing. 
                        </p>
                        <p className="text-ab pb0">
                        Click on the button below to be notified when its time
                          </p>
                        
                        <div className="row justify-content pt-2">
                          <div  className="col-md-4 col-8 col-lg-3">
                            <div id="donothing" className="do-nothing"><button className="donothing">
                              #doNothing</button></div></div>
                      ...
                      <div>
                        ...
                        <div className="mob-res row justify-content-center">
                          <div className="col-12 ">
                            <img draggable="false" src={tokenSlider[currentIndexSlider]} />
                          </div>
                          <div className="col-12">
                          <button
                          ...
                          >
                            <div className="slider">
                              <img draggable="false" src={leftArrow} alt="Previous" />
                              <img draggable="false" src={rightArrow} alt="Next" />
                            </div>
                          </button>
                          </div>
                ...
                {showSocial && (
                  <div id="glitch-background" className=" center-content">
                    <div className="trasition-1">
                      <img draggable="false" className="pb-2 gif-img" src={socialimg} />
                      ...
                      <div className="text-head">
                        ...
                        <p className="social-tag pb-5">
                          <p>
                          TheMemeTv is a meme coin with no intrinsic value or expectation of financial return. The road map is only 
                          indicative beyond Phase 3. The platform is for entertainment purposes only.
                          </p>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mob-res">
                      <div className="row road1 trasition-4">
                        <div className="col-12 col-lg-4 pb-2 col-md-4 road-min ">
                          <img draggable="false" className="w100" src={slider[currentIndexSlider]} alt="Slider Image" />
                        ...
                        <div className="col-12 col-lg-4 col-md-4 pb-2">
                          ...
                          <button className="slider-arrow right-arrow">
                            <div className="slider">
                              <img draggable="false"  onClick={handlePreviousSlider} src={leftArrow} alt="Previous" />
                              <img draggable="false" onClick={handleNextSlider} src={rightArrow} alt="Next" />
                            </div>
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="desk">
                      ...
                      <div className="row road1 trasition-4">
                        <div
                          ...
                          style={{
                            transform: `translateX(-${currentIndexDesk * 15}%)`,
                          }}>
                          <div className="col-12 col-lg-4 col-md-4 pb-2 road-min">
                            <img
                              className="img-desk"
          ...
          <div id="panel">
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <ul className="ul-button">
                ...
                >
                  <img draggable="false" src={getButtonDetails("play").icon} alt="Play Icon" />
                ...
                >
                  <img draggable="false" src={getButtonDetails("about").icon} alt="About Icon" />
                  <span>&nbsp;&nbsp;About</span>
                </li>
                <li
                  style={getButtonDetails("roadmap").style}
                ...
                >
                  <img draggable="false" src={getButtonDetails("token").icon} alt="Token Icon" />
                  <span>&nbsp;&nbsp;Token</span>
                </li>
                <li
                  style={getButtonDetails("social").style}
          ...
          <div>
            <div>
              <div id="navi-video" className="wallet-desk">
                <button onClick={handleDonothingClick} className="donothing">
                  #doNothing
                </button>
              </div>
            </div>
      ...
      {tapAnimations.map((animation) => (
        ...
        >
          +5
                    ...
                    <>
                    <button onClick={handleDonothingClick} className="mob-res btn-color flex flex-col justify-center items-center">
                      <img draggable="false" className="h-20 cnt-gif" src={arrow} alt="My GIF" />
                      <h3 className="mob-res donothing">#doNothing</h3>
                    </button> 
                    <button onClick={()=>{setIsGifOn(true)}} className="desk btn-color flex flex-col justify-center items-center">
                    <img draggable="false" className="h-20 cnt-gif" src={arrow} alt="My GIF" />
                    <h3> Watch,Tap,Play
                    Repeat</h3>
                    <h3 className="mob-res donothing">#doNothing</h3>
